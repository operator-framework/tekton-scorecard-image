...
public class StatusDescriptor {
     ...
     * @param description
     */
    public StatusDescriptor(String description, String displayName, String path, List<String> xDescriptors) {
        super();
    ...
    public StatusDescriptor withDescription(String description) {
        this.description = description;
        return this;
    }
    ...
    public StatusDescriptor withDisplayName(String displayName) {
        this.displayName = displayName;
        return this;
    }
    ...
    public StatusDescriptor withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public StatusDescriptor withxDescriptors(List<String> xDescriptors) {
        this.xDescriptors = xDescriptors;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StatusDescriptor.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StatusDescriptor) == false) {
            return false;
        }
        StatusDescriptor rhs = ((StatusDescriptor) other);
